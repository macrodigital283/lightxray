...
//
// v25 — server_status now carries the trailing-30-day traffic (traffic_30d_bytes
//   - up/down, traffic_30d_days covered, traffic_30d_since) so the pool can
//     show "used traffic (30d)" per server and per pool. Additive JSON fields
//     on the Hiddify-compatible response; nothing else changes.
const Number = "25"
